...
// class HiveCachePersistence extends CachePersistence
// with ReadinessMixin<void> {
...
//       throw Exception('Failed to initialize Hive');
//     }
//     _requestCacheBox = await Hive.openBox<Set<String>>(
// '${name}_requestCache');
//     // Cannot pre-type Maps with Hive
//     // ignore: strict_raw_type
...
//     assert(
//       isReady,
//       'Must complete initialization before calling '
// 'HiveCachePersistence.clear',
//     );
