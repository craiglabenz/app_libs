...
//         // safe to read until all initialization is complete.
//         final syncedUser = await _service.verifySocialUserSession(user);
//         lastUser = syncedUser;
...
//         final authResponse = await _service.syncAnonymousAccount(
//           socialAuthResponse,
//         );
...
//     switch (socialAuthResponse) {
//       case SocialAuthSuccess():
//         final authResponse = await _service.syncEmailPasswordAuthentication(
//           socialAuthResponse,
//         );
...
//     switch (socialAuthResponse) {
//       case SocialAuthSuccess():
//         final authResponse = await _service.logInWithEmailAndPassword(
//           socialAuthResponse,
//         );
...
//     switch (socialAuthResponse) {
//       case SocialAuthSuccess():
//         final authResponse = await _service.syncAppleAuthentication(
//           socialAuthResponse,
//         );
//         switch (authResponse) {
//           case AuthSuccess(:final user):
...
//         return authResponse;
//       case SocialAuthFailure():
//         _log.severe('Failed to logInWithApple');
//         return AuthFailure(socialAuthResponse.error);
//     }
//   }
...
//     switch (socialAuthResponse) {
//       case SocialAuthSuccess():
//         final authResponse = await _service.syncGoogleAuthentication(
//           socialAuthResponse,
//         );
//         switch (authResponse) {
//           case AuthSuccess(:final user):
...
//         return authResponse;
//       case SocialAuthFailure():
//         _log.severe('Failed to logInWithGoogle');
//         return AuthFailure(socialAuthResponse.error);
//     }
//   }
...
//     final syncAuthFailure = await _service.logOut();
//     if (syncAuthFailure != null) {
//       _log.severe(
//         'Failed to logout ${lastUser!.email} from $_service. This should not '
