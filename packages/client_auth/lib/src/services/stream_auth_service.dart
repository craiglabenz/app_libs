...
/// Defines the contract for authorizing users via Firebase.
abstract class BaseStreamAuth {
...
class FirebaseAuthService extends BaseStreamAuth {
  ...
  /// [AuthUser.anonymous] from the [users] Stream.
  ///
  /// Throws an [AuthenticationError] if an exception occurs.
  @override
...
Set<LoginType> loginTypesFromStrings(List<String> methods) {
  final Set<LoginType> types = <LoginType>{};
