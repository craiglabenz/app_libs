...
/// Pass-thru implementation of [BaseStreamAuth] with scriptable results.
class FakeFirebaseAuth extends BaseStreamAuth {
  ...
  Future<Either<AuthenticationError, LogoutSentinel>> logOut() async {
    _user = null;
    // This pumps the `Anonymous` user through the pipe - aka, a logout
    _doLogin();
