...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( AuthSession session)?  newUser,TResult Function()?  loggedOut,required TResult orElse(),}) {final _that = this;
switch (_that) {
case NewUserEvent() when newUser != null:
return newUser(_that.session);case LoggedOutEvent() when loggedOut != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( AuthSession session)  newUser,required TResult Function()  loggedOut,}) {final _that = this;
switch (_that) {
case NewUserEvent():
return newUser(_that.session);case LoggedOutEvent():
return loggedOut();}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( AuthSession session)?  newUser,TResult? Function()?  loggedOut,}) {final _that = this;
switch (_that) {
case NewUserEvent() when newUser != null:
return newUser(_that.session);case LoggedOutEvent() when loggedOut != null:
return loggedOut();case _:
...
class NewUserEvent implements AuthEvent {
  const NewUserEvent(this.session);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NewUserEvent&&(identical(other.session, session) || other.session == session));
}
...
@override
String toString() {
  return 'AuthEvent.newUser(session: $session)';
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthState&&(identical(other.session, session) || other.session == session));
}
...
class _AuthState extends AuthState {
  const _AuthState({this.session}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AuthState&&(identical(other.session, session) || other.session == session));
}
